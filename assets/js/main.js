!(function (e) {
  ...
  e(window).on("load", function () {
    e(".preloader").fadeOut(),
      setTimeout(function () {
        e(".slick-slider".length) &&
          e(".slick-slider").each(function () {
  ...
  e(window).on("scroll", function () {
    ...
    (t = e(".sticky-active")),
      ...
      e(window).scrollTop() > 800
        ? (t.parent().addClass(n), o > s ? t.removeClass(a) : t.addClass(a))
        : (t.parent().css("min-height", "").removeClass(n), t.removeClass(a)),
      (s = o),
